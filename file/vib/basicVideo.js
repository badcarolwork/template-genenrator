...
2.videoCss
 */
  var Lp_url = basic_url || "_basicUrlPath";
  var videoCssLink = "css/_vidCssPath"; //Choose the right type of video css
 ...
 */
  ...
  var video_src = "_vidFilePath";
  (resources.image.play_src =
    "https://s0.2mdn.net/creatives/assets/2910296/play_btn.png"),
    (resources.image.mute_src =
      "https://s0.2mdn.net/creatives/assets/2910296/mute_btn.png"),
    (resources.image.unmute_src =
      "https://s0.2mdn.net/creatives/assets/2910296/unmute_btn.png");
 ...
 */
  ...
  //basic FLD setting
  var FLD_src = _src || "_fldSrc",
    FLD_type = _type || "_fldType",
    FLD_cat = _cat || "_fldCat";
 ...
 */
  ...
  var BUILD_FRAME = function videoFramework(callback) {
    ...
    var ttt = [
      "play_btn",
      [null, [resources.image.play_src]],
      "mute_btn",
      ["m-area", [resources.image.mute_src]],
      "unmute_btn",
  ...
  var ADD_VIDEO_LISTENER = function videoListeners() {
    ...
    this.counterExit = exitClickHandler.bind(
      this,
      Lp_url,
      basic_label || "exit"
    );
  ...
  function show() {
    Performics.settings.isResourceLoaded = true;
    is_clickable = true;
  ...
  function addVideoFLD(u2) {
    ...
    if (currentPos > quartile1 && u2 === DBM_quart1) {
      videoM.dom.vid.removeEventListener(
        "timeupdate",
        this.videoFLD_quart1,
        false
      );
  ...
  function setImage() {
    ...
    document.querySelector("#unmute_btn>div>img").src =
      resources.image.unmute_src;
  }
